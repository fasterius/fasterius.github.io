...
tibble::tribble(
    ...
    "nf-core/modules/quartonotebook", "Creator \\& Maintainer", "A Nextflow/nf-core module for rendering Quarto notebooks (in development).", "https://github.com/fasterius/modules/tree/quartonotebook/modules/nf-core/quartonotebook",
    "nf-core/modules/spaceranger", "Contributor", "A nf-core module for processing Visium data using the Space Ranger software.", "https://github.com/nf-core/modules/tree/master/modules/nf-core/spaceranger",
...
I have been involved in a number of advanced bioinformatics courses. All of the
courses are offered to PhD students, post-docs and other high-level researchers
in Sweden ([NBIS](https://nbis.se/)), Switzerland
([SIB](https://www.sib.swiss/)) and other countries in the
...
have taught, please visit [my website](https://fasterius.github.io/teaching/).
