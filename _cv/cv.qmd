...
tibble::tribble(
    ~what, ~role, ~text, ~href,
    "nf-core/spatialvi (pipeline)", "Creator \\& Maintainer", "A nf-core pipeline for analysing 10x Visium spatial transcriptomics data.", "https://github.com/nf-core/spatialvi",
