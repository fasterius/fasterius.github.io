...
tibble::tribble(
    ...
    "nf-core/rifseq", "(creator \\& maintainer)", "A Nextflow pipeline for analysing the RIF-seq sequencing method for \\textbf{large-scale drug screening} by the Mats Nilsson laboratory (currently not publicly available).", "",
